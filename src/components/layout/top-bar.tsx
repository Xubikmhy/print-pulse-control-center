      ...
      <div className="px-4 py-3 flex items-center justify-between">
        <div className="flex items-center">
          <button
            ...
            className="mr-4 lg:hidden text-app-gray-500 hover:text-app-gray-700 dark:text-app-gray-400 dark:hover:text-white"
          >
            <Menu className="h-6 w-6" />
          </button>
          
          <div>
            <h1 className="text-xl font-semibold text-app-gray-800 dark:text-white">
              PrintPulse Control Center
            </h1>
